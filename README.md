...
def _get_embedding(self, text: str) -> List[float]:
    ...
    return embedding.tolist()
```
<br>Далее просто в функциях поиска и индексации заменены query_embedding или embedding на соответствующие им переменные с или без флага is_query, например:<br>
```python
